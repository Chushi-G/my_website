...
# Variables are for alcohol servings types (ie. Beer, Wine,Spirits, & Total)
# For missing values...
...
ggplot(top_25_beer, aes(x = country, y = beer_servings, fill = country))+
  geom_col()+
...
ggplot(top_25_wine, aes(x = country, y = wine_servings, fill = country))+
  geom_col()+
  geom_smooth(se= FALSE)+
...
ggplot(top_25_spirit, aes(x = country, y = spirit_servings, colour = country))+
  geom_col()+
  geom_smooth(se= FALSE)+
...
ggplot(top_25_wine, aes(x = country, y = wine_servings, colour = country))+
  geom_col()+
  geom_smooth(se= FALSE)+
  labs(title = "Top 25 Wine Consuming Countries", x= "Countries", y= "Wine Servings" )
  NULL
